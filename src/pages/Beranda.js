        ...
        return (
          <div>
            <div className="px-10 flex justify-between h-[10vh] shadow-md mb-5 content-center py-3">
                ...
                <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-black bg-white hover:bg-blue-800   font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">Kategori 
                </button>
                ...
                <div className="items-center text-center container mb-10 bg-big-1 h-[60vh] text-white content-center">
